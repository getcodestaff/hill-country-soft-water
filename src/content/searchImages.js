...
console.log(
  "The output are two lines for every missing image referenced in the markdown file."
)
console.log("The first line is the path to the markdown file.")
console.log(
  "The second line is the line number in the markdown file where the missing image is referenced."
)
...
console.log(`searching directory tree at ${__dirname}`)
